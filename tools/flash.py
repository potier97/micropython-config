...
def flash_esp32(erase=False):
    ...
    if chip_type == "esp32":
        ...
        write_flash_cmd = f"esptool --chip {chip_type} --port {port} --baud 460800 write_flash --flash_freq 40m --flash_mode dio --flash_size detect 0  ./firmware/ESP8266_GENERIC-20231005-v1.21.0.bin"
    else:
